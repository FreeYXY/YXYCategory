...
static char * const yxy_eventIntervalKey = "yxy_eventIntervalKey";
...
-(void)setupBtnCornerRadiusReact:(CGRect)rect rectCorner:(UIRectCorner)rectCorner cornerRadii:(CGSize)cornerRadii{
