...
extern const NSString * YXYToastPositionTop;
extern const NSString * YXYToastPositionCenter;
extern const NSString * YXYToastPositionBottom;
extern const NSString * YXYToastPositionBottomOffUp;
...
/**
 ...
 @param position The toast's center point. Can be one of the predefined YXYToastPosition
...
/**
 `YXYToastStyle` instances define the look and feel for toast views created via the
 `makeToast:` methods as well for toast views created directly with
 `toastViewForMessage:title:image:style:`.
 
 @warning `YXYToastStyle` offers relatively simple styling options for the default
 toast view. If you require a toast view with more complex UI, it probably makes more
 sense to create your own custom UIView subclass and present it with the `showToast:`
 methods.
 */
@interface YXYToastStyle : NSObject
...
/**
 Creates a new instance of `YXYToastStyle` with all the default values set.
 */
- (instancetype)initWithDefaultStyle NS_DESIGNATED_INITIALIZER;

/**
 @warning Only the designated initializer should be used to create
 an instance of `YXYToastStyle`.
 */
...
/**
 `YXYToastManager` provides general configuration options for all toast
 notifications. Backed by a singleton instance.
 */
@interface YXYToastManager : NSObject
...
/**
 ...
 with with a nil style. By default, this is set to `YXYToastStyle`'s default
 style.
...
/**
 ...
 Default is `YXYToastPositionBottom`.
 
 @param position The default center point. Can be one of the predefined
 YXYToastPosition constants or a `CGPoint` wrapped in an `NSValue` object.
 */
+ (void)setDefaultPosition:(id)position;

/**
 Returns the default toast position. Default is `YXYToastPositionBottom`.
